...
// 6-variant (A-F) CTA copy/layout test via verifiedBadgeInvoiceCtaFlag. That
// test infrastructure isn't part of what's being tested here — this page
// tests LANGUAGE, not CTA copy — so this uses a single fixed layout/copy
// (equivalent to the EN page's "A" control: classic 3-step layout, no
// visual redesign), hard-coded rather than wired into the flags system.
// Same two honesty rules as every other Verified Badge asset, non-negotiable:
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Por ahora, solo PDF. Si tu factura sale de tu software de contabilidad en otro formato, exportala o imprimila a PDF primero, y después sellá ese archivo.",
  },
  {
    q: "¿Qué plan necesito?",
    a: "Cualquier plan, incluido Free, sin tarjeta. Free incluye 3 sellos Verified Badge por mes. El plan Pro o superior tiene sellado ilimitado, sin cargo por sello. Sellá un archivo directamente desde el menú de Nuevo Documento de tu panel — los desarrolladores también pueden hacerlo desde el chat de Console o la API, ver la documentación para desarrolladores.",
  },
  {
    ...
    <main className="flex min-h-screen flex-col bg-white">
      ...
      <section className="mx-auto flex w-full max-w-3xl flex-col items-center gap-5 px-6 py-10 text-center">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
          La IA puede falsificar una factura en segundos. Demostrá que la tuya es realmente tuya.{" "}
        ...
        <p className="max-w-xl text-base text-slate-600">
          ...
          a uno de tus clientes en segundos. Sellá primero tu factura real: un hash y una prueba con identidad
      ...
      <section className="mx-auto w-full max-w-3xl px-6 pb-4">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-3">
          {[
            ...
            {
              step: "2. Sellá la factura",
              body: "Subí el PDF de tu factura terminada desde tu panel — SignedBy la hashea, le pone marca de tiempo y genera tu insignia.",
            },
            {
              step: "3. Insertá la insignia",
              body: "Poné la insignia en tu factura antes de enviarla. El cliente la escanea y llega a una página pública — sin necesidad de cuenta.",
            },
          ].map((s) => (
        ...
        >
          ...
          <p className="mt-1.5 text-sm text-slate-600">
            Paso a paso: verificá tu identidad una vez, y exactamente qué pasa cada vez que sellás y enviás una
      ...
      <section className="mx-auto w-full max-w-3xl px-6 py-10 text-center">
        <h2 className="text-2xl font-semibold text-slate-900">Asegurá tu factura gratis</h2>
