  ...
  return (
    <main className="flex min-h-screen flex-col bg-white">
      ...
      <section className="mx-auto flex w-full max-w-3xl justify-center px-6 pb-10">
        {/* Reverted 2026-08-06 to the badge shown in isolation — the
            invoice-in-context version (hero-verified-badge-invoice.png)
            didn't match this page's AI-detector framing above (headline,
            FAQ, opengraph-image.tsx all still make the "false-positive AI
            detector" claim, not an invoice-fraud one). That image now
            belongs to /verified-badge-invoices, a separate page built for
            the invoice-fraud angle instead of forcing one hero image to
            carry two different pitches. */}
