  ...
  return (
    <main className="flex min-h-screen flex-col bg-white">
      ...
      <section className="mx-auto flex w-full max-w-3xl flex-col items-center gap-5 px-6 py-10 text-center">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Every rental, signed before they leave the dock.</h1>
        <p className="max-w-xl text-base text-slate-600">
          A verbal handshake doesn&apos;t cover you when a jet ski comes back with a cracked hull. Send the agreement,
          capture their ID, get it signed on a phone at the counter — done before they&apos;re out of the marina.
        </p>
