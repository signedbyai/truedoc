...
const SIGNUP_HREF = "/login?intent=signup&utm_source=vs_adobe&utm_medium=cta&utm_campaign=vs_adobe_page";
  ...
  return (
    <main className="flex min-h-screen flex-col bg-white">
      ...
      <section className="mx-auto flex w-full max-w-3xl flex-col items-center gap-6 px-6 py-16 text-center">
        ...
        <CtaLink href={SIGNUP_HREF} color={ctaColor} page="vs-adobe" position="hero">
          Start for free →
        </CtaLink>
      ...
      <section className="mx-auto w-full max-w-3xl px-6 pb-20 text-center">
        ...
        <CtaLink href={SIGNUP_HREF} className="mt-5" color={ctaColor} page="vs-adobe" position="footer">
          Start for free →
        </CtaLink>
      </section>
