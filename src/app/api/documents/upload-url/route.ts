...
// Step 1 of the direct-to-R2 upload. Authenticates and enforces the upload
// rate limit, then issues a presigned PUT URL for a server-chosen key. The
...
//
// No free-plan cap check here (or in finalize below) as of 2026-08-05 —
// creating a draft no longer spends anything from either Free pool; the cap
// is enforced at each action's actual completion (checkFreePlanSendCap in
// the send route, checkFreePlanSealCap in sealDocumentAction). See plan.ts.
