...
def build_verification_slide(prs, template_slide):
    ...
    # hero-verified-badge-deck.png (not hero-verified-badge.png) -- a
    # deck-only copy generated by the real generateVerifiedBadgeImage()
    # with a working QR payload (signedby.ai/verified-badge). The plain
    # hero-verified-badge.png is the live marketing asset on the real
    # /verified-badge page and encodes a fake placeholder hash that 404s
    # / "No match found"s when scanned (direct report, 2026-08-08) --
    # left untouched here since fixing the live site is a bigger call
    # than fixing the deck, and wasn't asked for.
    badge_path = f"{APP_PUBLIC}/hero-verified-badge-deck.png"
